...
N=81 ## 101-8-2-10(adapter length 5)
#N=64 ## 75-8-2-1  ### further require the reads  were overlapped with at least 10bp adapter
...
rm -rf temp.aligned.sort.dedup.reMap.bam.T3_3bp.bed temp.aligned.sort.dedup.reMap.bam.T5_3bp.bed
